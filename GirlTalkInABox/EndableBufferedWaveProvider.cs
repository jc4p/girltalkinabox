...
// Note: This is just the newest version of BufferedWaveProvider stolen from https://github.com/naudio/NAudio/blob/fa4911195aaf259251acf79ef9fd2e85ea6f940b/NAudio/Wave/WaveProviders/BufferedWaveProvider.cs
// since there hasn't been a NuGet release in months and I dont want to include the entire solution.
namespace GirlTalkInABox
{
    ...
    /// </summary>
    public class EndableBufferedWaveProvider : IWaveProvider
    {
        ...
        public EndableBufferedWaveProvider(WaveFormat waveFormat)
        {
